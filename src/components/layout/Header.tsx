              ...
              if (isDropdown) {
                return (
                  <div key={item.name} className="relative group">
                    ...
                    {/* Dropdown Menu */}
                    <div className="absolute top-full left-0 w-80 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-2 group-hover:translate-y-0">
